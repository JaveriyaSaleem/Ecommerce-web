...
const Product = () => {
  ...
  const {productId,api} = useContext(MyContext)
...
getProduct()
    ...
    const filteredProduct = products.find((product) => product._id === myproductId);
...
/>
        ...
        {/* Details Section */}
        <div>
          <h1 className="text-3xl font-bold mb-2">{filteredProduct.ProductName}</h1>
        ...
        <div className="mb-4">
          ...
          <button onClick={CartFunction} className="bg-black text-white hover:bg-white border border-black hover:text-black px-6 py-2 rounded mb-6 transition">
            Add to Bag
          </button>
          <p className="text-gray-700 mb-4">Discover effortless everyday style with this must-have essential, crafted for comfort, versatility, and confidence. A staple piece that fits right into your wardrobe.</p>
