...
const Email = () => {
  return (
    <main className='-mb-20  z-10 relative px-2 sm:px-10 py-5'>
     
      <div className='bg-black grid grid-cols-1 md:grid-cols-12 md:justify-around items-center py-5 px-5 sm:py-10 sm:px-20 rounded-4xl gap-5'>
        {/* left side  */}
