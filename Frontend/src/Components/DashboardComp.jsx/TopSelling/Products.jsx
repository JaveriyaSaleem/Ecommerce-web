  ...
  return (
    <div className='flex flex-col items-center gap-3 mb-10 rounded-2xl w-full max-w-[270px] mx-auto'>
      ...
      <div className='flex flex-col gap-2 text-center '>
        ...
        <div className="flex gap-1"><button className='cursor-pointer border py-1 px-2 sm:py-2 sm:px-4 rounded-full bg-black text-white hover:scale-[1.07] transition duration-300 ease-in-out text-[8px] sm:text-[14px] md:text-[16px]' onClick={props.functionForCart}>Add to Cart</button> <button className='cursor-pointer border py-1 px-2 sm:py-2 sm:px-4 rounded-full hover:scale-[1.07] transition duration-300 ease-in-out text-[8px] sm:text-[14px] md:text-[16px]' onClick={props.onClick}>View Item</button>
        </div>
      </div>
    </div>
  )
