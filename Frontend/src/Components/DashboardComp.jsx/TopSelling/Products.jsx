...
const Products = (props) => {
  ...
  return (
    <div className='flex flex-col items-center gap-3 mb-10 rounded-2xl w-full max-w-[270px] mx-auto'>
      <figure className='overflow-hidden w-full aspect-[3/4] sm:h-auto sm:w-full'><img src={props.img} alt="img of a shirt" className='transition duration-300 ease-in-out hover:scale-[1.04] rounded-2xl h-full w-full object-contain' /></figure>
