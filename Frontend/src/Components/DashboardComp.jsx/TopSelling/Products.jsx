...
const Products = (props) => {
  ...
  return (
    <div className='flex flex-col gap-3 mb-10 w-70 rounded-2xl'>
      <figure className='overflow-hidden'><img src={props.img} alt="img of a shirt" className='w-70 object-contain p-4 transition duration-300 ease-in-out hover:scale-[1.04] rounded-4xl' /></figure>
